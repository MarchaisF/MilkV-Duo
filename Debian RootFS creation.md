...
# Minimal Debian Trixie rootfs generation
    ...
    sudo mmdebstrap \
      --arch=arm64 \
      --variant=minbase \
      --include=systemd,systemd-sysv,dbus,iproute2,isc-dhcp-client,nfs-common,openssh-server,nano,ca-certificates,udev,vim-tiny,locales,systemd-timesyncd,kmod,sudo \
      trixie \
      ./duos-rootfs \
